...
namespace YourTube
{
    public class GetSongIdTitle
    {
        ...
        {
            string uri = "https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&pageToken=" + pageToken + "&playlistId=" + url + "&key=" + UserGetSet.apiKey + "";
            WebClient wc = new WebClient();
        ...
        //public void DesirializeJson(string requestData, )
        //{
